...
import { SECTIONS, type SectionId, type FlexState, type StudioPreset } from "./types";

export default function Page() {
  const [state, setState] = useState<FlexState>(DEFAULT_FLEX_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Flex Studio" controls={controls} preview={output} /></AppShell>;
}
